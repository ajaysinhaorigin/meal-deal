...
const SearchBar = () => {
    ...
    return (
        ...
        <div className="text-center my-2">
            <input
                type="text"
                className="font-medium px-4 w-7/12 lg:w-3/12 py-3 lg:py-3 text-gray-700 focus:outline-none rounded-l-3xl border-[1px] border-r-0 border-gray-300"
            ...
            <button
                type="submit"
                className="font-medium px-2 py-3 lg:py-3 w-3/12 lg:w-1/12  bg-gray-700 text-white hover:bg-gray-500 rounded-r-3xl border-[1px] border-l-0 border-gray-700 "
                onClick={() => {
